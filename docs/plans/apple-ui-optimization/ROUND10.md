...
| 2 | 软件主页图 png vs webp 宽高比记录/修复 | ✅ | `e19144e` |
...
| 7 | VitePress `.doc-hero` 深色模式间距与对比 | ✅ | `9df1d7d` |
| 8 | 全站 `prefers-reduced-motion` 二次扫描 | ✅ | `601bdc8` |
| 9 | zh 文案第七轮（nav / a11y / placeholder） | ✅ | `cca8d00` |
| 10 | en / zh-Hant 同步本轮 copy + PROGRESS 核对 | ✅ | `6e95af2` / 验收 `6a617cc` |
