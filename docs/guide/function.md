...
- **Block 交互架构**：消息由独立功能块组成（正文、思维链、知识检索、网络搜索、工具调用、Anki 卡片、任务列表等 17 种），正文块支持 Markdown / 代码 / LaTeX / Mermaid / 表格等富文本渲染
...
- **多模板系统**：10 种内置模板，支持 HTML / CSS / Mustache 自定义
- **3D 预览**：可视化预览卡片效果
- **任务控制**：暂停 / 恢复 / 取消 / 重试
...
- 模型分配覆盖 10 个功能点（对话、制卡、题库批改、嵌入、重排、对话标题、试卷 OCR、翻译、多模态嵌入、多模态重排）
