...
- **Skills 技能系统（渐进披露）**：内置导师模式/制卡模式/文献综述/调研模式；12 组工具能力按需加载（共 61 个工具）；支持自定义技能并可接入 MCP 生态。
...
- **技能系统，用练代替刷，用能力驱动成长。**：拍照识题（OCR）、题型识别、标签分类、题答分离、AI 解答；支持顺序/随机/错题优先/限时/模拟考试/每日一练/组卷等 8 种练习模式。
...
- **IREC 灵感回归**：相似题召回、灵感卡片与变式题推荐；灵感图谱与错题库双向联动，把“当时的思路与灵光一闪”沉淀为可复用的能力。
