        ...
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,0.76fr)_minmax(0,1.9fr)] gap-7 sm:gap-10 lg:gap-8 xl:gap-12 items-center">
          <div className="flex flex-col items-start text-left order-2 lg:order-1">
            ...
            <a
              ...
              className="focus-ring inline-flex items-center gap-2 text-[13px] font-medium text-[color:var(--apple-muted)] hover:text-[color:var(--apple-ink)] transition-colors mb-5 sm:mb-8"
            >
